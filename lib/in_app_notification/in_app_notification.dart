...
import 'package:kobi/in_app_notification/src/interact_animation_controller.dart';
import 'package:kobi/in_app_notification/src/size_listenable_container.dart';
...
class InAppNotification extends StatelessWidget {
  ...
  ///
  /// This method will awaits an animation that showing the notification.
  static Future<void> dismiss({required BuildContext context}) async {
    final controller = _NotificationController.of(context);
