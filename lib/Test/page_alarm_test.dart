...
import 'class_custom_color.dart';

class AlarmUIPage extends StatefulWidget {
  @override
  _AlarmUIPageState createState() => _AlarmUIPageState();
}

class _AlarmUIPageState extends State<AlarmUIPage> {
  ...
  List<AlarmInfo> testAlarms = [];

  @override
  void initState() {
    _alarmTime = DateTime.now();
    AlarmInfo testAlarm = AlarmInfo(id:123124,title:'sdgsdg',alarmDateTime:DateTime.now(),isPending: false, gradientColorIndex: 1);
    // _alarmHelper.initializeDatabase().then((value) {
    //   print('------database intialized');
    //   loadAlarms();
    // });
    testAlarms.add(testAlarm);
    testAlarms.add(testAlarm);
    super.initState();
  }
